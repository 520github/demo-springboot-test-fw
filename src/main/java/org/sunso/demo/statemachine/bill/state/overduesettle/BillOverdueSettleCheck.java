...
@Component
public class BillOverdueSettleCheck implements Check<BillOverdueSettleContext> {
    @Override
    public Response check(State state, State target, Event event, BillOverdueSettleContext context) {
