...
@Component
public class BillOverdueCheck implements Check<BillOverdueContext> {
    @Override
    public Response check(State state, State target, Event event, BillOverdueContext context) {
