...
@Component
public class BillNormalSettleCheck implements Check<BillNormalSettleContext> {
    @Override
    public Response check(State state, State target, Event event, BillNormalSettleContext context) {
